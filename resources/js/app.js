...
import { checkEmpty, initilizeTippy, tippyInstanceDestroy } from "./helper/common-helper";
import { ListSidePannel } from "./helper/list/side-pannel";
...
class OrdersTable {
    ...
    handleViewOrder(orderId) {
        ...
        new ListSidePannel(config)?.initialize();

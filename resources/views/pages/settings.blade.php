...
@section('title', 'Settings | Billing&Management')
@section('page-content')
    <div class="SETTINGS_WRAPPER" id="SETTINGS_WRAPPER">
     <div class="bg-white">
        <div class="mx-3 py-3">
            <div class="">
                <h3 class="m-0 title">Admin and Management Staff</h3>
                <span class="sub-text">Manage all your Admin and Mangement Staff here.</span>
            </div>
        </div>
        <hr class="mt-0 mb-2">
    </div>
    ...
    <div class="section-wrapper" data-section="SETTINGS">
        <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between p-3">
            <div class="tabluator-input-search-wrapper d-none" id="SETTINGS_SEARCH">
            ...
            <div class="mt-2 mt-lg-0">
                <button type="button" class="btn btn-ash refresh-table  d-none" data-section="SETTINGS">
                ...
                <button class="btn btn-dark add-btn d-none" id="add-new-admin-and-management-staff" class="add-new-admin-and-management-staff" data-section="SETTINGS">
        ...
        <div class="position-relative parent-loader-height" id="SETTINGS_LOADER">
            ...
            <div class="empty-wrapper d-none" id="SETTINGS_EMPTY_WRAPPER">
            ...
            <div id="SETTINGS_TABLE" class="d-none"></div>
        </div>
    </div>
...
@vite(['resources/css/app.css', 'resources/js/pages/settings.js'])
@endsection

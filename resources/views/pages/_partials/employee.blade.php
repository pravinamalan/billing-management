<div class="EMPLOYEE_WRAPPER" id="EMPLOYEE_WRAPPER">
    <div class="bg-white">
        <div class="mx-3 py-3">
            <div class="">
                <h3 class="m-0 title">Employee</h3>
                <span class="sub-text">Manage all your sfaff here.</span>
            </div>
        </div>
        <hr class="mt-0 mb-2">
    </div>
    ...
    <div class="section-wrapper" data-section="EMPLOYEE">
        <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between p-3">
            <div class="tabluator-input-search-wrapper d-none" id="EMPLOYEE_SEARCH">
            ...
            <div class="mt-2 mt-lg-0">
                <button type="button" class="btn btn-ash refresh-table  d-none" data-section="EMPLOYEE">
                ...
                <button class="btn btn-dark add-btn d-none" id="add-new-employee" class="add-new-employee" data-section="EMPLOYEE">
        ...
        <div class="position-relative parent-loader-height" id="EMPLOYEE_LOADER">
            <div class="private-spinner-main-wrapper private-spinner--hide">
                <div class="private-spinner private-spinner--link private-spinner--huge">
                    <div class="private-spinner-wrapper">
                        <svg height="64" width="64" class="private-spinner__ring" viewBox="0 0 50 50">
            ...
            <div class="empty-wrapper d-none" id="EMPLOYEE_EMPTY_WRAPPER">
            ...
            <div id="EMPLOYEE_TABLE" class="d-none"></div>
        </div>

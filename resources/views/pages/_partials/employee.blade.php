    ...
    <div>
        <div class="d-flex align-items-center justify-content-between p-3">
            ...
            <div>
                ...
                <button class="btn btn-dark" id="add-new-employee" class="add-new-employee">
        ...
        <div class="empty-wrapper d-none" style="padding: 30px;background: #f9f9f9;border: 1px solid #ddd;border-radius: 2px;" id="EMPLOYEE_EMPTY_WRAPPER">
